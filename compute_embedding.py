...
if __name__ == "__main__":
    output = compute_embedding("trained_models/encoderVI-t1573361390-a100-e2-l12.h5",512,"./mnist/fashion-mnist_test.csv")
    output.to_csv("mnist/fashion_precomp_encoderBasic_train.csv", index=False)
